...
const LandRegisterPage = ({ isMobile=false, currUserData, regLandData, setRegLandData, LoadLand }) => {
    ...
    useEffect(() => {
        ...
        setLandArea(regLandData.land_area.toLocaleString());
        setLandPrice(regLandData.land_predict_price.toLocaleString());
    }, [])
    ...
    const changeLandArea = (e) => {
        ...
        setLandArea(removedCommaValue.toLocaleString());
    }

    const changeLandPrice = (e) => {
        const value = e.target.value;
        const removedCommaValue = Number(value.replaceAll(",", ""));
        setLandPrice(removedCommaValue.toLocaleString());
    }
        ...
        if (index === 1) {
            ...
            return (
                <div>
                    ...
                    <div><div style={{display:"flex"}}>
                        <LandInput id="landArea" type="text" placeholder="거래 면적 입력" value={landArea} onChange={changeLandArea}/>
                        <UnitText>m²</UnitText>
                    </div></div>
            ...
            return (
                <div>
                    ...
                    <div style={{display:"flex"}}>
                        <LandInput id="landPrice" type="text" placeholder="거래 가격 입력" defaultValue={landPrice} value={landPrice} onChange={changeLandPrice}/>
                        <UnitText>원</UnitText>
                    </div>
                </div> 
            );
    ...
    if (!isMobile) {
        return (
            <Background>
                <Container>
                    <CloseButton onClick={() => setRegLandData(null)}/>
